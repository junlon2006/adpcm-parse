...
void adpcm_coder(short* indata, char* outdata, int len, adpcm_state_t *state) {
  short *inp = NULL;    /* Input buffer pointer */
  char *outp = NULL;    /* output buffer pointer */
  ...
  int step = 0;         /* Stepsize */
  int valpred = 0;      /* Predicted output value */
...
void adpcm_decoder(char* indata, short* outdata, int len, adpcm_state_t *state) {
  char *inp = NULL;   /* Input buffer pointer */
  short *outp = NULL; /* output buffer pointer */
  int sign = 0;       /* Current adpcm sign bit */
  int delta = 0;      /* Current adpcm output value */
  int step = 0;       /* Stepsize */
